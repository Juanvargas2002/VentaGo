        ...
        <div class="card-body">
            ...
            <form class="FormularioAjax" action="<?php echo SERVER_URL ?>ajax/usuarioAjax.php" method="POST" data-form="save">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="rol2" id="rol2" class="form-control" value="Vendedor" readonly>
                    <input type="text" name="rol" id="rol" class="form-control" value="Vendedor" readonly hidden>
                </div>
